...
/**
 * File: Input.java
 * Created by Atlas IND on 7/7/15 at 12:21 PM.
...
public class Input {
    ...
    public static final int MAX_KEYS = 256, MAX_BUTTONS = 16;
    ...
    private static boolean[] lastKey = new boolean[MAX_KEYS];
    private static boolean[] lastButton = new boolean[MAX_BUTTONS];

    public static void update() {
        for(int i = 0; i < MAX_KEYS; i++)
            lastKey[i] = getKey(i);
        for(int i = 0; i < MAX_BUTTONS; i++)
            lastButton[i] = getMouse(i);
    }
    ...
    public static boolean getMouseDown(int button) {
        return getMouse(button) && !lastButton[button];
    }
    ...
    public static void setMousePosition(Vector2f position) { Mouse.setCursorPosition((int)position.getX(), (int)position.getY()); }
